...
public partial class HAMHMod : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        try
        {
            ...
            CompanionAbilityManager.Instance.Initialize();
            stopwatch5.Stop();
            Log.LogInfo($"[HAMH] Initialized CompanionAbilityManager in {stopwatch5.ElapsedMilliseconds}ms.");

            var stopwatch6 = Stopwatch.StartNew();
            CompanionShopManager.Instance.Initialize();
            stopwatch6.Stop();
            Log.LogInfo($"[HAMH] Initialized CompanionShopManager in {stopwatch6.ElapsedMilliseconds}ms.");
